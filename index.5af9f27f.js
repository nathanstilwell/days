...
})({"dq8aA":[function(require,module,exports) {
"use strict";
...
var _time = require("@nathanstilwell/time");
var _timeDefault = parcelHelpers.interopDefault(_time);
var _numeralsJs = require("./modules/numerals.js");
var _numeralsJsDefault = parcelHelpers.interopDefault(_numeralsJs);
var _datesSuckJs = require("./modules/datesSuck.js");
var _datesSuckJsDefault = parcelHelpers.interopDefault(_datesSuckJs);
        ...
        case "time-span":
            {
                ...
                if (end === "now") {
                    m.innerText = (0, _numeralsJsDefault.default)((0, _timeDefault.default).daysBetween(begin, new Date()));
                    break;
                }
                m.innerText = (0, _numeralsJsDefault.default)((0, _timeDefault.default).daysBetween(begin, end));
                break;
            }
        case "date":
            {
                const { date  } = m.dataset;
                m.innerText = (0, _numeralsJsDefault.default)((0, _timeDefault.default).daysFrom((0, _timeDefault.default).d(date)));
                break;
            }
        case "now":
            m.innerText = (0, _datesSuckJsDefault.default)(new Date());
            break;
    }
}); /*
...
},{"@nathanstilwell/time":"7HcpP","./modules/numerals.js":"lSOr2","./modules/datesSuck.js":"2sFCK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7HcpP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "T", ()=>T);
parcelHelpers.export(exports, "invalidDateString", ()=>invalidDateString);
parcelHelpers.export(exports, "d", ()=>d);
parcelHelpers.export(exports, "t", ()=>t);
parcelHelpers.export(exports, "timeDiff", ()=>timeDiff);
parcelHelpers.export(exports, "daysSince", ()=>daysSince);
parcelHelpers.export(exports, "daysFrom", ()=>daysFrom);
parcelHelpers.export(exports, "daysBetween", ()=>daysBetween);
...
const d = (datestring)=>invalidDateString(datestring) ? null : new Date(datestring);
const t = (date)=>d(date)?.getTime();
const timeDiff = (now)=>(historicDate)=>now - historicDate.getTime();
const daysSince = (when, now = Date.now())=>Math.floor(timeDiff(now)(when) / T.day);
const daysFrom = (when, now)=>Math.abs(daysSince(when, now));
const daysBetween = (from, to)=>{
    if (invalidDateString(from) || invalidDateString(to)) return null;
    // convert date strings to ECMA epoch numbers
    const b = t(to) ?? 0;
    const a = t(from) ?? 0;
    // sort date numbers into descending order for subtraction
    const [prev, next] = sortDescending([
        a,
        b
    ]);
...
exports.default = toNumerals;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2sFCK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const months = [
    "JAN",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dq8aA","X6g1Y"], "X6g1Y", "parcelRequire2f99")
